...
extension Spreadsheet {
  ...
  public struct Operation: Codable {
    ...
    var deleteDimension: GenericRequest?
    var appendDimension: SheetRange?
    var insertDimension: GenericRequest?
    var deleteSheet: SheetRange?
    var moveDimension: MoveCellsRequest?
...
public extension Spreadsheet.Operation {
  ...
  /// Updates many cells at once.
    static func updateCells(sheetId: Int, rows: [[String]], start: Sheet.Location)
  ...
  static func clear(sheetId: Int) -> Spreadsheet.Operation {
    .init(
      updateCells: .init(
        rows: nil, fields: "userEnteredValue",
        start: nil,
        range: .init(
          sheetId: sheetId,
          dimension: nil,
  ...
  static func insert(sheetId: Int, range: Range<Int>, dimension: Sheet.Dimension)
    -> Spreadsheet.Operation
  {
    .init(
  ...
  static func delete(sheetId: Int, range: Range<Int>, dimension: Sheet.Dimension)
    -> Spreadsheet.Operation
  {
    .init(
      deleteDimension: .init(
        range: .init(
          sheetId: sheetId,
          dimension: dimension,
          length: nil,
  ...
  static func move(sheetId: Int, range: Range<Int>, to dest: Int, dimension: Sheet.Dimension)
    -> Spreadsheet.Operation
  {
    .init(
      moveDimension: .init(
  ...
  static func append(sheetId: Int, size: Int, dimension: Sheet.Dimension)
    -> Spreadsheet.Operation
  {
    .init(
      appendDimension: .init(
        sheetId: sheetId,
        dimension: dimension,
        length: size,
        startIndex: nil,
...
extension Array where Element == Sheet.RowData {
  public init(from rows: [[String]]) {
